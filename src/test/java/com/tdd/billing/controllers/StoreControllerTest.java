...
//        requestDTO.setName("Test Store");
//
//        when(storeService.create(any(StoreRequestDTO.class), any())).thenReturn(sampleStore);
//
//        mockMvc.perform(post("/api/stores")
//                        .contentType(MediaType.MULTIPART_FORM_DATA)
//                        .param("store", objectMapper.writeValueAsString(requestDTO)))
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.name").value("Test Store"));
//
//        verify(storeService).create(any(StoreRequestDTO.class), any());
//    }
//
//    @Test
...
//        requestDTO.setName("Test Store");
//
//        when(storeService.create(any(StoreRequestDTO.class), any())).thenThrow(new RuntimeException("DB error"));
//
//        mockMvc.perform(post("/api/stores")
//                        .contentType(MediaType.MULTIPART_FORM_DATA)
//                        .param("store", objectMapper.writeValueAsString(requestDTO)))
...
//                .andExpect(result -> Assertions.assertEquals("Error creating store",
